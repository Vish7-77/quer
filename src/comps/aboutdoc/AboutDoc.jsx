...
const AboutDoc = () => {
  ...
  return (
    <>
    <section className='mobnof aBoutdoc'>
 <div className="docinfoleft" style={{height:isShown ?'183vh':'30vh' }}>
...
<div className="box">
    ...
    <section className='deskt aBoutdoc' >
...
<div className=" mobno docinforight" style={{marginTop:'isShown'? '6rem' :'15rem'}}>
<div className="box">
    <img className='dbqu' src={dbqu} alt="" />
    <h6>"Sexual health encompasses a plethora of sexual problems. The stigmas associated with it limit people from seeking help.I urge people to educate themselves about intimacy-related issues and seek holistic treatment, which involves a combination of both medical and psychological approaches."</h6>
    <h3>Dr.Anita Shyam</h3>
...
<div className="martop0 deskt docinforight" style={{marginTop:'isShown'? '1rem !important' :'2rem'}}>
<div className="box">
    <img className='dbqu' src={dbqu} alt="" />
    <h6>"Sexual health encompasses a plethora of sexual problems. The stigmas associated with it limit people from seeking help.I urge people to educate themselves about intimacy-related issues and seek holistic treatment, which involves a combination of both medical and psychological approaches."</h6>
    <h3>Dr.Anita Shyam</h3>
